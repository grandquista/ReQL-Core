...
static const uint8_t right_curly_bracket = 0x7D;
static const uint8_t colon = 0x3A;
static const uint8_t comma = 0x2C;
static const uint8_t quotation = 0x22;
static const uint8_t reverse_solidus = 0x5C;
...
static const uint8_t json_char_0x00[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x30};
static const uint8_t json_char_0x01[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x31};
static const uint8_t json_char_0x02[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x32};
static const uint8_t json_char_0x03[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x33};
static const uint8_t json_char_0x04[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x34};
static const uint8_t json_char_0x05[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x35};
static const uint8_t json_char_0x06[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x36};
static const uint8_t json_char_0x07[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x37};
static const uint8_t json_char_backspace[2] = {
  reverse_solidus, 0x62};
static const uint8_t json_char_tab[2] = {
  reverse_solidus, 0x74};
static const uint8_t json_char_linefeed[2] = {
  reverse_solidus, 0x6E};
static const uint8_t json_char_0x0B[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x42};
static const uint8_t json_char_formfeed[2] = {
  reverse_solidus, 0x66};
static const uint8_t json_char_carriage_return[2] = {
  reverse_solidus, 0x72};
static const uint8_t json_char_0x0E[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x45};
static const uint8_t json_char_0x0F[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x30, 0x46};
static const uint8_t json_char_0x10[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x30};
static const uint8_t json_char_0x11[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x31};
static const uint8_t json_char_0x12[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x32};
static const uint8_t json_char_0x13[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x33};
static const uint8_t json_char_0x14[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x34};
static const uint8_t json_char_0x15[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x35};
static const uint8_t json_char_0x16[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x36};
static const uint8_t json_char_0x17[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x37};
static const uint8_t json_char_0x18[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x38};
static const uint8_t json_char_0x19[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x39};
static const uint8_t json_char_0x1A[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x41};
static const uint8_t json_char_0x1B[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x42};
static const uint8_t json_char_0x1C[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x43};
static const uint8_t json_char_0x1D[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x44};
static const uint8_t json_char_0x1E[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x45};
static const uint8_t json_char_0x1F[6] = {
  reverse_solidus, 0x75, 0x30, 0x30, 0x31, 0x46};
static const uint8_t json_char_quotation[2] = {
  reverse_solidus, quotation};
static const uint8_t json_char_reverse_solidus[2] = {
  reverse_solidus, reverse_solidus};

enum {
  char_left_square_bracket = left_square_bracket,
  char_right_square_bracket = right_square_bracket,
  char_left_curly_bracket = left_curly_bracket,
  char_right_curly_bracket = right_curly_bracket,
  char_colon = colon,
  char_comma = comma,

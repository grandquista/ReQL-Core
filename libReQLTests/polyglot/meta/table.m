...
@interface ObjcTestsMetaQueriesForCreatingAndDeletingTables : XCTestCase

@end

@implementation ObjcTestsMetaQueriesForCreatingAndDeletingTables
...
- (void)test2 {
  ...
  NSString *var1 = @"id";
  NSNull *var2 = [NSNull null];
  [var0 setObject:var2 forKey:var1];
  NSString *var3 = @"name";
  NSString *var4 = @"rethinkdb";

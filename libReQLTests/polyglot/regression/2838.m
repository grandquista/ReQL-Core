...
@interface ObjcTestThatReturnChangesFailsGracefully : XCTestCase

@end

@implementation ObjcTestThatReturnChangesFailsGracefully
...
- (void)test2 {
  ...
  NSString *var1 = @"Too many changes, array truncated to 40.";
  [var0 addObject:var1];
  XCTAssert([var0 isEqualTo:var0]);
  [connection close];
}

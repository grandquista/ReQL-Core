...
TEST_CASE("c Test ReQL interface to geo indexes", "[c][ast]") {
  ...
  SECTION("test38") {
    ...
    std::unique_ptr<uint8_t> buf13(new uint8_t[4]);
    const uint8_t src13[] = "dist";
    reql_string_init(var13.get(), buf13.get(), 4);
    reql_string_append(var13.get(), src13, 4);

    std::unique_ptr<ReQL_Obj_t> var14(new ReQL_Obj_t);
    reql_number_init(var14.get(), 0.055659745396754216);
  ...
  SECTION("test39") {
    ...
    std::unique_ptr<ReQL_Obj_t> var14(new ReQL_Obj_t);
    reql_number_init(var14.get(), 0.11130264976984369);
  ...
  SECTION("test40") {
    ...
    std::unique_ptr<uint8_t> buf16(new uint8_t[3]);
    const uint8_t src16[] = "doc";
    reql_string_init(var16.get(), buf16.get(), 3);
    reql_string_append(var16.get(), src16, 3);
  ...
  SECTION("test43") {
    ...
    std::unique_ptr<ReQL_Obj_t> var14(new ReQL_Obj_t);
    reql_number_init(var14.get(), 5.565974539675422e-05);
    ...
    std::unique_ptr<ReQL_Obj_t> var21(new ReQL_Obj_t);
    reql_number_init(var21.get(), 1565.1090992178897);
  ...
  SECTION("test44") {
    ...
    std::unique_ptr<ReQL_Obj_t> var14(new ReQL_Obj_t);
    reql_number_init(var14.get(), 8.726646259990191e-09);
    ...
    std::unique_ptr<ReQL_Obj_t> var21(new ReQL_Obj_t);
    reql_number_init(var21.get(), 0.24619691677893205);

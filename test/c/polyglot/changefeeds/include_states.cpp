...
TEST_CASE("c Test `include_states`", "[c][ast]") {
  ...
  SECTION("test2") {
    ...
    ReQL_Obj_c var5;
    _C::CTypes::string buf5(new uint8_t[5]);
  ...
  SECTION("test10") {
    ...
    ReQL_Obj_c var20;
    _C::CTypes::pairs pair20(new ReQL_Pair_t[1]);
  ...
  SECTION("test14") {
    ...
    ReQL_Obj_c var22;
    _C::CTypes::string buf22(new uint8_t[2]);
    ...
    ReQL_Obj_c var24;
    _C::CTypes::string buf24(new uint8_t[7]);
  ...
  SECTION("test15") {
    ...
    ReQL_Obj_c var12;
    _C::CTypes::string buf12(new uint8_t[7]);

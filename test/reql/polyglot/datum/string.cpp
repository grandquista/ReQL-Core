...
TEST_CASE("c Tests of converstion to and from the RQL string type 265", "[c][ast]") {
  ...
  SECTION("test3") {
    std::unique_ptr<ReQL_Obj_t> var0(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf0(new uint8_t[30]);
  ...
  SECTION("test13") {
    ...
    std::unique_ptr<ReQL_Obj_t> var1(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf1(new uint8_t[0]);
    const uint8_t src1[] = "";
  ...
  SECTION("test20") {
    ...
    std::unique_ptr<ReQL_Obj_t> var3(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf3(new uint8_t[0]);
    const uint8_t src3[] = "";
    ...
    std::unique_ptr<uint8_t[]> buf5(new uint8_t[0]);
    const uint8_t src5[] = "";
  ...
  SECTION("test22") {
    ...
    std::unique_ptr<ReQL_Obj_t> var2(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf2(new uint8_t[0]);
    const uint8_t src2[] = "";
    ...
    std::unique_ptr<ReQL_Obj_t> var4(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf4(new uint8_t[0]);
    const uint8_t src4[] = "";
  ...
  SECTION("test26") {
    ...
    std::unique_ptr<ReQL_Obj_t> var2(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf2(new uint8_t[20]);
  ...
  SECTION("test27") {
    ...
    std::unique_ptr<ReQL_Obj_t> var2(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf2(new uint8_t[13]);
  ...
  SECTION("test47") {
    ...
    std::unique_ptr<ReQL_Obj_t> var2(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf2(new uint8_t[11]);
  ...
  SECTION("test49") {
    ...
    std::unique_ptr<ReQL_Obj_t> var3(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf3(new uint8_t[14]);
  ...
  SECTION("test53") {
    ...
    std::unique_ptr<ReQL_Obj_t> var3(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf3(new uint8_t[22]);
  ...
  SECTION("test63") {
    ...
    std::unique_ptr<ReQL_Obj_t> var7(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf7(new uint8_t[0]);
    const uint8_t src7[] = "";
  ...
  SECTION("test88") {
    ...
    std::unique_ptr<ReQL_Obj_t> var3(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf3(new uint8_t[16]);
  ...
  SECTION("test100") {
    ...
    std::unique_ptr<ReQL_Obj_t> var3(new ReQL_Obj_t);
    std::unique_ptr<uint8_t[]> buf3(new uint8_t[13]);

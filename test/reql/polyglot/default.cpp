...
TEST_CASE("reql Tests r.default", "[reql][ast]") {
  ...
  SECTION("test26") {
    std::unique_ptr<ReQL_Obj_t> var0(new ReQL_Obj_t);
    std::unique_ptr<ReQL_Byte[]> buf0(new ReQL_Byte[31]);
    const ReQL_Byte src0[] = "No attribute `b` in object:\n{}";
    reql_string_init(var0.get(), buf0.get(), src0, 31);
  }

  SECTION("test27") {
    std::unique_ptr<ReQL_Obj_t> var0(new ReQL_Obj_t);
    std::unique_ptr<ReQL_Byte[]> buf0(new ReQL_Byte[35]);
    const ReQL_Byte src0[] = "Cannot reduce over an empty stream.";
    reql_string_init(var0.get(), buf0.get(), src0, 35);
  }
  ...
  SECTION("test29") {
    std::unique_ptr<ReQL_Obj_t> var0(new ReQL_Obj_t);
    std::unique_ptr<ReQL_Byte[]> buf0(new ReQL_Byte[36]);
    const ReQL_Byte src0[] = "Expected type NUMBER but found NULL.";
    reql_string_init(var0.get(), buf0.get(), src0, 36);
  }

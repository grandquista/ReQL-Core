...
int _reql_lua_reqlqueryprinter_print_query(lua_State *L);
int _reql_lua_reqlqueryprinter_compose_term(lua_State *L);
int _reql_lua_reqlqueryprinter_join_tree(lua_State *L);
